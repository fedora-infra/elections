...
import sys
sys.path.append('/srv/elections/elections')
sys.path.append('/srv/elections')
...
turbogears.update_config(configfile="/srv/elections/dev.cfg", modulename="elections.config")
